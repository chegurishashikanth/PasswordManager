...
const Manager = () => {
    ...
    const savePassword = () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            toast('Error: Site, Username, and Password must be longer than 3 characters', {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
    ...
    const deletePassword = (id) => {
        ...
        const confirmDeletion = window.confirm("Do you really want to delete this password?");
        if (confirmDeletion) {
    ...
    return (
        <>
            ...
            <div className="p-3 md:container min-h-[88.2vh]">
